...
{
    //private static string ConnectionString = @"data source=localhost\sqlexpress;initial catalog=netba;user id=netba_web;password=go_muddogs07!;packet size=4096";
    public AutoSub()
    {
    }
