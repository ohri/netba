<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Rules.aspx.cs" Inherits="netba.Pages.Rules" %>
...
Win by 40+   points 7-0
    ...
    <h6>
        <a href="#TOP">Back to top</a></h6>
    <hr />
    <a name="NETBAOC"></a>OWNERS COMMITTEE<br />
    <br />
