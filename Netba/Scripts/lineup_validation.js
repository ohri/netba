...
function validate_position( position, player_position )
{
	...
	switch( position )
	{
		...
		case 2:
			...
			break;
		case 3:
			if( player_position != 'F' && player_position != 'GF' && player_position != 'FG' )
			{
				ret = "Only F and GF are allowed at SF";
			}
			break;
		case 4:
			...
			break;
		case 5:
		    if (player_position != 'C' && player_position != 'CF' && player_position != 'FC')
			{
				ret = "Only C and FC are allowed at C";
			}
			break;
	}
	return ret;
